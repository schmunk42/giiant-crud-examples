...
class Customer extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\giiant\sakila\models\Payment::className(), ['customer_id' => 'customer_id']);
    }
    ...
    {
        return $this->hasMany(\giiant\sakila\models\Rental::className(), ['customer_id' => 'customer_id']);
    }
}
