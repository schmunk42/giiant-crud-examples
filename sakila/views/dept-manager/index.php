...
* @var giiant\sakila\models\search\DeptManager $searchModel
*/

    $this->title = 'Dept Managers';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="dept-manager-index">
    ...
    [
        'label' => '<i class="glyphicon glyphicon-arrow-left"> Departments</i>',
        'url' => [
            'departments/index',
        ],
    ],
