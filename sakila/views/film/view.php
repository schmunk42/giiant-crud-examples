...
<div class="film-view">
    ...
    <?php $this->beginBlock('giiant\sakila\models\Film'); ?>
...
[
            ...
            "value" => function($model){
                if ($rel = $model->getActor()->one()) {
                    return yii\helpers\Html::a($rel->actor_id,["actor/view", 'actor_id' => $rel->actor_id,],["data-pjax"=>0]);
                } else {
                    return '';
                }
            },
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['giiant\sakila\models\Film'],
    'active'  => true,
],[
