...
<div class="address-view">
    ...
    <?php $this->beginBlock('giiant\sakila\models\Address'); ?>
...
[
            ...
            "value" => function($model){
                if ($rel = $model->getStore()->one()) {
                    return yii\helpers\Html::a($rel->store_id,["store/view", 'store_id' => $rel->store_id,],["data-pjax"=>0]);
                } else {
                    return '';
                }
            },
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['giiant\sakila\models\Address'],
    'active'  => true,
],[
    ...
    'label'   => '<small>Stores <span class="badge badge-default">'.count($model->getStores()->asArray()->all()).'</span></small>',
    'active'  => false,
], ]
                 ]
    );
