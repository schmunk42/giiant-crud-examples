...
use giiant\sakila\models\Departments;
use giiant\sakila\models\search\Departments as DepartmentsSearch;
...
class DepartmentsController extends Controller
{
	...
	{
		if (($model = Departments::findOne($dept_no)) !== null) {
			return $model;
		} else {
